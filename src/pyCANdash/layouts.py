    ...
    def __init__(self):
        ...
        if self.logCfg['dataDir'] is not None:
            if os.path.isdir(self.logCfg['dataDir']):
                ...
                self.dataDir = os.path.join(os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "..", "data")), "")
        ...
        for filename in os.listdir(self.dataDir):
            ...
            zeroSizeFlag = os.path.getsize(fpath) < EMPTY_BLF_SIZE_BYTES
